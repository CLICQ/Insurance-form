				...
				<div class="b-page-frame">
					<div class="b-page-frame_inner">
						<div class="b-wrapper b-wrapper-main">
							<div class="b-top-search" style="padding:0">
								<div class="b-form">
									<script type="text/javascript">
										var cntrSearch;
										$(function() {
									...
									<noindex>
										...
										<form class="b-form b-form-search-main -visor-no-click" method="post" id="frmSearch" name="frmSearch"  style="z-index: 100;">
											...
											<div  style="padding:10px 15px 10px; ">
												...
												<div class="b-inline b-form-elem elem-size-big elem-style-marked b-destination" style="display:block; text-align:center; min-width:100%">
											...
											<div class="row-style-even" style="padding:0 15px 10px; border-top: 1px dashed rgb(204, 204, 204)">
												<div class="b-line b-rooms">
												
													<div class="b-inline b-form-elem elem-size-big elem-style-marked b-destination" style="width:100%">
														<div>
															<label class="b-form-elem_label" style="font-size:16px;" for="dest">Выберите тип полиса</label>
														</div>
														<div class="b-form-elem_wrapper b-wrapper-autocomplete js-acContainer" style="display:block; text-align:center;">
															<!--<span class="watermark_container" style="display: inline-block; position: relative;">
																-->
																...
																<div style="width:100%;text-align:center;display:block">
																	<div  style="display:inline; margin: 0 auto;">
																			...
																			<input style="vertical-align:middle;" <?if($_POST["groupOfProgram"]=='odn'){echo "checked";}?> type="radio" class="input-radio" value="odn" name="groupOfProgram" id="groupOfProgram1" onclick="SelectTypeActions('odn');">
																			<label style="vertical-align:middle; padding: 0 35px 0 5px" for="groupOfProgram1" class="radio-item" >на одну поездку</label>
																			<input style="vertical-align:middle;"<?if($_POST["groupOfProgram"]=='mul'){echo "checked";}?> type="radio" class="input-radio" value="mul" name="groupOfProgram" id="groupOfProgram2" onclick="SelectTypeActions('mul');">
																			<label style="vertical-align:middle; padding: 0 5px 0 5px" for="groupOfProgram2" class="radio-item" >многократный полис</label>
																	</div>
														...
														<div class="for-one for-all b-rooms" >
															...
															<div class="b-inline b-form-elem b-adults elem-size-big elem-style-marked" >
																<div class="b-form-elem_wrapper" id="daysCountBlock">
																	<?if($_POST["groupOfProgram"]=="odn"){?>
																		<input  name='daysCount' type='text' style='width:125px' value='<?=$_POST["daysCount"]?>'/>
																	<?}else{?>
											...
											<div class="row-style-even" style="padding:0 15px 10px; border-top: 1px dashed rgb(204, 204, 204)">
												<div class="b-line for-one for-all">
													...
													<div  class="b-inline b-form-elem b-adults elem-size-big elem-style-marked" title="Количество взрослых">
														<div class="b-form-elem_wrapper b-wrapper-autocomplete js-acContainer">
															<div id="radio" >
																	<input style="vertical-align:middle;" <?if($_POST["InsuredSum"]=='15000'){echo "checked";}?> type="radio" id="InsuredSum1" name="InsuredSum" checked="checked" value="15000" />
																		<label style="vertical-align:middle;" for="InsuredSum1" class="radio-item" >15000</label>
																	<input style="vertical-align:middle;" <?if($_POST["InsuredSum"]=='30000'){echo "checked";}?> type="radio" id="InsuredSum2" name="InsuredSum" value="30000"/>
																		<label style="vertical-align:middle;" for="InsuredSum2" class="radio-item" >30000</label>
																	<input style="vertical-align:middle;" <?if($_POST["InsuredSum"]=='50000'){echo "checked";}?> type="radio" id="InsuredSum3" name="InsuredSum" value="50000"/>
																		<label style="vertical-align:middle;" for="InsuredSum3" class="radio-item" >50000</label>
																	<input style="vertical-align:middle;" <?if($_POST["InsuredSum"]=='100000'){echo "checked";}?> type="radio" id="InsuredSum4" name="InsuredSum" value="100000"/>
																		<label style="vertical-align:middle;" for="InsuredSum4" class="radio-item" >100000</label>
																<!--<span style="margin-right:10px">&nbsp;</span>-->
															</div>
														</div>
													</div>
													<div class="b-inline b-form-elem elem-size-big elem-style-marked b-destination">
														<select name="Currency" id="Currency"  class="selector" >
											...
											<div class="row-style-odd" style="padding:0 15px 10px; border-top: 1px dashed rgb(204, 204, 204)">
												...
												<div id="AdvOptions" class="for-all for-one b-rooms" >
													<?=$AdvancedParametersHtmlString?>
												</div>
											</div>
											<div class="row-style-even" style="padding:0 15px 10px; border-top: 1px dashed rgb(204, 204, 204)">
												<div class="b-inline b-form-submit for-one for-all b-rooms">
...
<script>
		...
		function SelectTypeActions(type){
			...
			if(type=="odn"){
				...
				daysCountBlock.innerHTML = "<input  name='daysCount' style='width:125px' type='text' value='1'/>";
			}else{
