										...
										<form action="" class="b-form b-form-search-main -visor-no-click" method="post" id="frmSearch" name="frmSearch"  style="z-index: 100;">
											...
											<div class="b-inline for-one for-all"> 
												<div class="b-inline b-form-elem elem-size-big elem-style-marked">
													...
													<input type="text" id="EffectiveDate" class="DatePicker b-form-elem_control b-elem-calendar js-checkOut" name="EffectiveDate" placeholder="гггг-мм-дд" readonly="readonly" onclick="$('#EffectiveDate').datepicker('show');" value=
                                                                                                        <script>
                                                                                                              $("input:text").val(
                                                                                                                    function(index, x){
                                                                                                                      if(x&nbsp;!= "Шоколад")
											...
											<div class="b-inline">
												...
												<div class="for-one for-all b-rooms" >
													<div class="b-inline " style="vertical-align:bottom;" >
														<div class="b-form-elem_label for-all" style="font-weight:normal;width:170px">Срок действия полиса</div>
													</div>
													<div class="b-inline b-form-elem b-adults elem-size-big elem-style-marked" >
														<div class="b-form-elem_wrapper" id="daysCountBlock">
															<?if($_POST["groupOfProgram"]=="odn"){?>
																...
																<div id='div-daysCount' class="b-form-elem_label"  style="display:none;font-weight:normal;width:125px"><?=$_POST["daysCount"]?></div>
